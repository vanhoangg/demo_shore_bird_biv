...
class FinanceHomeV1 extends StatefulWidget {
  const FinanceHomeV1({super.key, this.season = FinanceSeason.hot});
...
class _FinanceHomeV1State extends State<FinanceHomeV1>
  ...
  @override
  void didUpdateWidget(covariant FinanceHomeV1 oldWidget) {
                        ...
                        Row(
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: _theme.iconBackgroundColor,
